...
class ScheduleViewController: OCKDailyPageViewController {
    ...
    // loops; creating the color object here seems to prevent this issues
    func getDrugColor(i: Int) -> UIColor {
