...
//        }
    ...
    func taskViewController(_ taskViewController: ORKTaskViewController, didFinishWith reason: ORKTaskViewControllerFinishReason, error: Error?) {
        ...
        // 4a. Retrieve the result from the ResearchKit
        let survey = taskViewController.result.results!.first(where: { $0.identifier == "environmentalAttunementQuestion" }) as! ORKStepResult
