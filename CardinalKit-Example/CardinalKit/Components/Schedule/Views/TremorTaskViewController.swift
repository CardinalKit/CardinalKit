//
//  TremorTaskViewController.swift
//  CardinalKit_Example
//
//  Created by Kabir Jolly on 3/4/21.
...
class TremorTaskViewController: OCKInstructionsTaskViewController, ORKTaskViewControllerDelegate {
    ...
    override func taskView(_ taskView: UIView & OCKTaskDisplayable, didCompleteEvent isComplete: Bool, at indexPath: IndexPath, sender: Any?) {
        ...
        let tremorViewController = ORKTaskViewController(task: tremorTask, taskRun: nil)
        tremorViewController.delegate = self

        // 3a. Present the survey to the user
        present(tremorViewController, animated: true, completion: nil)
    }
...
class TremorItemViewSynchronizer: OCKInstructionsTaskViewSynchronizer {
