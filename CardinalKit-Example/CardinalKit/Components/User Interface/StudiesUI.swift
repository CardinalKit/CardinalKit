...
struct VisualizationsView: View {
    ...
    init(color: Color) {
        ...
        self.visualizations = [
            VisualizationData(
                title: "Coffee Survey",
                description: "Weekly coffee consumption",
                type: "PieChart",
                values: [10.0, 10.0, 20.0, 0.0, 0.0, 5.0, 45.0]
            ),
            VisualizationData(
                title: "iStep",
            ...
            VisualizationData(
                title: "Tip-toes",
                description: "How long can you tip-toe?",
                type: "DiscreteGraph",
                values: [
                    [
            ...
            VisualizationData(
                title: "Hanoi",
                description: "Time of each Tower's of Hanoi attempt.",
                type: "LineGraph",
                values: [
                    [
                        ORKValueRange(value: 1),
                    ...
                    [
                        ORKValueRange(value: 180),
                        ORKValueRange(value: 178),
                        ORKValueRange(value: 170),
                        ORKValueRange(value: 140),
                        ORKValueRange(value: 121),
                        ORKValueRange(value: 60),
                        ORKValueRange(value: 43),
                    ]
                ]
            )
        ]
